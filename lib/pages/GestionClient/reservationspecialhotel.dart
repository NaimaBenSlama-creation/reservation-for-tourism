...
class reservationspecialhotel extends StatefulWidget {
  const reservationspecialhotel({Key? key}) : super(key: key);

  @override
  State<reservationspecialhotel> createState() => _reservationspecialhotelState();
}

class _reservationspecialhotelState extends State<reservationspecialhotel> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Suivi Special Hotel'),
      ),
      body: Column(
        children: [
          ElevatedButton(
