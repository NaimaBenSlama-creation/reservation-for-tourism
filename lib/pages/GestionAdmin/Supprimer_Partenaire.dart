...
class SuppPartenairesScreen extends StatefulWidget {
  @override
  _SuppPartenairesScreenState createState() => _SuppPartenairesScreenState();
}

class _SuppPartenairesScreenState extends State<SuppPartenairesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Supprimer Partenaire'),
      ),
      body: Column(
        children: [
          ElevatedButton(
