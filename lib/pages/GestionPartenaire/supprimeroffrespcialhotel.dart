...
class supprimerspecialhotel extends StatefulWidget {
  const supprimerspecialhotel({Key? key}) : super(key: key);

  @override
  State<supprimerspecialhotel> createState() => _supprimerspecialhotelState();
}

class _supprimerspecialhotelState extends State<supprimerspecialhotel> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Supprimer Offre Spécial  d\'hotel'),
      ),
      body: Column(
        children: [
          ElevatedButton(
