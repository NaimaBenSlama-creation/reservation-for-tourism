...
class HotelOfferForm extends StatefulWidget {
  const HotelOfferForm({Key? key}) : super(key: key);

  @override
  State<HotelOfferForm> createState() => _HotelOfferFormState();
}

class _HotelOfferFormState extends State<HotelOfferForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ajouter Hotel'),
      ),
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  labelText: 'Ville',
                  hintText: 'Entrez le nom de ville',
                  contentPadding: EdgeInsets.symmetric(
                    vertical: 10,
                    horizontal: 20,
                  ),
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  ...
                  FirebaseFirestore.instance
                      ...
                      .then((_) {
                    setState(() {
                      _message = 'Hotel ajouté avec succès!';
                    });
                  }).catchError((error) {
                    print('Error adding Hotel : $error');
                    setState(() {
                      _message =
                      'Une erreur s\'est produite lors de l\'ajout du Hotel.';
                    });
                  });
