...
class voiturespecialReservationScreen extends StatefulWidget {
  final String image;
  final String nom;
  final String boite;
  final String prix;
  ...
  voiturespecialReservationScreen({
    Key? key,
    required this.image,
    required this.nom,
    required this.boite,
  ...
  @override
  _voiturespecialReservationScreenState createState() => _voiturespecialReservationScreenState();
}

class _voiturespecialReservationScreenState extends State< voiturespecialReservationScreen > {
